...
const Hero = () => {
  ...
  return (
    <section
      ref={heroRef}
      className="p-8 pb-16 md:p-10 lg:pt-4 lg:p-20 font-medium bg-gradient-to-tr from-[#001E80] via-[#e4eaff]  overflow-x-clip md:items-center gap-3"
    >
      <div className="md:flex items-center justify-center gap-16">
        <div className="md:w-[478px]">
          <div className="text-5xl md:text-7xl font-black my-7 bg-gradient-to-b from-black to-[#002499] text-transparent bg-clip-text tracking-tighter">
            Create, Govern, Thrive
          </div>
          <div className="text-xl lg:text-2xl tracking-tighter opacity-85">
            Create and manage cross-chain SubDAOs with gasless transactions and secure account abstraction.
          </div>
